...
<!-- saved from url=(0031)http://www.gog.com/en/error/404 -->
<HTML xml:lang="en" xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>Error 404</TITLE>
...
<STYLE>
BODY {
	MARGIN: 0px auto; WIDTH: 950px; margin:0 auto; FONT: 11px "Lucida Grande",Arial,Verdana,sans-serif; BACKGROUND: url(/500/body_bg.jpg) #d4d4d4 repeat-x; padding-top:80px;
}
DIV.error404_main {
	POSITION: relative; MARGIN: 31px 21px 0px; WIDTH: 950px; BACKGROUND: url(/500/error404.jpg) no-repeat; HEIGHT: 500px
}
SPAN.main_txt {
