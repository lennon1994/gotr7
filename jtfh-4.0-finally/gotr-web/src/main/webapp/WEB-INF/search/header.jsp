...
<head>
	...
	<!-- http://www.jq22.com/jquery/font-awesome.4.6.0.css -->
		...
		<div class="nav-top">
			<div class="top-nav">
				...
				<ul class="nav1" style="width:1200px !important; ">
					...
					<li><a href="search.action">景点</a></li>
					<li><a href="toSearch.action">自定义旅行</a></li>
					<li><a href="note.action">写游记</a></li>
					<li><a href="toNote.action?thispage=1">查看游记</a></li>
					<li><a href="#">常见问题</a></li>
					<li><a href="#">联系我们</a></li>
					<li><a href="#">关于我们</a></li>
