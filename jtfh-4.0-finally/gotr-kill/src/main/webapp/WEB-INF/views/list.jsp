...
<div style="height:700px;background: url(../images/back.jpg) no-repeat">
	<div class="container" style="padding:300px auto;">
						...
						<c:forEach var="sk" items="${list}">
							<tr>
								...
								<td><a class="btn btn-info"
									href="${ctx}/seckill/${sk.seckillId }/detail" target="_blank">link</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
		...
		<div class="footer-bottom-grids">
			...
			<div class="container">
				<div class="footer-bottom-top-grids">
					...
					<div class="clearfix"> </div>
					<div class="copyright">
						<p>Copyright &copy; 2017-2020.Company name All rights reserved.<a target="_blank" href=""></a></p>
					</div>
				</div>
			</div>
		</div>
